...
%	 {AdjoinAt Snake positions {AdjoinAt {AdjoinAt Snake.positions.1 x Xtarget} y Ytarget}|Snake.positions.2}
 %     end

      fun{Teleport Snake XT YT}
	 local NewPositionHeadX NewPostionHeadFinal in
	    
	    NewPositionHeadX = {AdjoinAt Snake.positions.1 x XT}
	    NewPostionHeadFinal = {AdjoinAt NewPositionHeadX y YT}
	    {AdjoinAt Snake positions NewPostionHeadFinal|Snake.positions.2}.positions
	 end
      end
%--------------------
