...
% Declare your functions here
	 ...
	 if {HeadNorth SnakePositions} then {AddHeadNorth SnakePositions}
	 elseif {HeadSouth SnakePositions} then {AddHeadSouth SnakePositions}
	 elseif  {HeadEast SnakePositions} then {AddHeadEast SnakePositions}
