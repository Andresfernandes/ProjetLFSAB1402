...
% Declare your functions here
	 ...
	 if SnakePositions.1.to==north then {AddHeadNorth SnakePositions}
	 elseif SnakePositions.1.to==south then {AddHeadSouth SnakePositions}
	 elseif  SnakePositions.1.to==east then {AddHeadEast SnakePositions}
